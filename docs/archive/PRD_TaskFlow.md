...
- Bắt buộc tuân thủ guidelines từ `@d:\taskflowfinal\.agents\skills\vercel-react-best-practices\SKILL.md` cho cấu trúc frontend Next.js.
...
- Bắt buộc tham chiếu `@d:\taskflowfinal\.agents\skills\frontend-design\SKILL.md` để mang lại UI premium, hiển thị text rõ nét. Áp dụng animation từ `@d:\taskflowfinal\.agents\skills\vercel-react-view-transitions\SKILL.md` cho màn hình chuyển đổi.
...
- Tuân thủ quy chuẩn audit từ `@d:\taskflowfinal\.agents\skills\web-design-guidelines\SKILL.md` cho mọi hiển thị hệ thống UI.
